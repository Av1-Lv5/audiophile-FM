		...
		<footer className="bg-black">
			<div className="container mx-auto py-6 px-4 flex flex-col gap-8 text-white lg:px-20">
				<div className="flex flex-col gap-6 sm:flex-row justify-between items-center">
					...
					<div className="flex gap-4 text-xs flex-col items-center sm:flex-row sm:items-start sm:gap-6">
						<NavItems />
					</div>
				</div>
				<p className="opacity-60 text-center sm:text-start text-sm w-full lg:w-2/3">
				...
				<div className="flex flex-col gap-6 items-center justify-between text-sm sm:flex-row">
